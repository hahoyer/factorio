...
//                CellStyle = MyStyle           ,
        ...
        {
            args.Cancel = args.PropertyType == typeof(TimeSpan);
            if(args.PropertyType != typeof(MyTimeSpan))
                return;

            args.Column.SortMemberPath = args.Column.SortMemberPath+ ".Value";
        ...
        public sealed class MyTimeSpan : DumpableObject, INotifyPropertyChanged
        {
            ...
            public override string ToString() { return Value.Format3Digits(); }
        ...
        sealed class FileClusterProxy : INotifyPropertyChanged
        {
            ...
            public void Refresh()
            {
                ...
                DurationValue = FileCluster.Duration;
                Duration = new MyTimeSpan(DurationValue);
                OnPropertyChanged();
            }
