...
static class Extension
{
    ...
    {
        var interpreter = luaTable.GetByReflection<NLua_Lua>("_Interpreter");
    ...
    public static string ParseExceptionMessage(this string value, IContext context)
    {
        ...
        return Tracer.FilePosition(message.FileName, message.Position, 0, message.Position, 0, "Lua") + message.Text;
    }
}